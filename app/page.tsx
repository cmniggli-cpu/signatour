    ...
    <div className="nigpage">
      ...
      <section className="blk" id="referenzen" style={{ background: 'var(--paper2)' }}>
        <div className="wrap">
          ...
          <div className="refs">
            <div className="ref"><span className="badge">Live-Buchung</span><iframe loading="lazy" src="https://vtour.cloud/e16tqj/ee82pes6/" allow="accelerometer; magnetometer; gyroscope; fullscreen; xr-spatial-tracking" allowFullScreen title="Referenz-Tour: SPA Signature Tour" /><div className="bot"><b>SPA Signature Tour</b><a href="https://vtour.cloud/e16tqj/ee82pes6/" target="_blank" rel="noopener noreferrer">Tour öffnen</a></div></div>
