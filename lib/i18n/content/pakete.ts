...
const de: PaketeContent = {
  ...
  garantie: {
    ...
    markenText: 'Ihre Tour trägt Ihre Handschrift – Farben, Logo und Navigation exakt in Ihrem Corporate Design, ohne fremdes Branding (ab Signature Tour).',
  },
  rechner: {
  ...
  service: {
    ...
    subtitle: 'Optional und jederzeit kündbar – damit Ihre Tour aktuell, sicher und messbar bleibt.',
    empfohlen: 'Empfohlen',
...
const fr: PaketeContent = {
  hero: {
    ...
    subtitle: 'Prix unique par visite, pas d’abonnement – la visite vous appartient. Aucun contrat, aucune location de plateforme.',
  },
  tiers: [
    {
      name: 'Basic',
  ...
  garantie: {
    ...
    markenText: 'Votre visite porte votre signature – couleurs, logo et navigation exactement selon votre charte graphique, sans branding tiers (dès la Signature Tour).',
  },
  rechner: {
    ...
    groups: [
      {
        ...
        items: [
          ...
          { name: 'Panoramas supplémentaires', price: 'dès CHF 150.– par scène', nutzen: 'La visite évolue – de nouvelles zones peuvent être ajoutées à tout moment.' },
      ...
      },
      {
        ...
        items: [
          { name: 'Version multilingue (DE / FR / EN)', price: 'dès CHF 300.– par langue', nutzen: 'Vos hôtes et acheteurs découvrent la visite dans leur langue – plus de portée, plus de confiance.' },
          { name: 'Google Street View & intégration Business', price: 'CHF 490.– une fois', nutzen: 'Votre visite apparaît directement dans Google Maps et votre profil d’entreprise – visible là où vos clients cherchent.' },
          { name: 'Pack QR codes print & affichage', price: 'CHF 240.–', nutzen: 'Autocollants vitrine, chevalets de table et panneaux mènent directement à la visite – votre établissement devient la porte d’entrée.' },
        ],
      },
      {
        title: '03 · Conversion & expérience',
        items: [
          { name: 'Formulaire de capture de leads dans la visite', price: 'CHF 390.– une fois', nutzen: 'Les visiteurs anonymes deviennent des demandes qualifiées – avec nom et adresse e-mail.' },
      ...
      },
      {
        ...
        items: [
          { name: 'Mise à jour saisonnière de scènes', price: 'CHF 180.– par scène / pack saison CHF 650.–', nutzen: 'Terrasse d’été, ambiance de Noël, nouvelles plantations – votre visite reste actuelle et vivante.' },
          ...
          { name: 'Rapport de performance visite', price: 'CHF 150.– par rapport', nutzen: 'Vues, pièces les plus consultées, clics sur les points de réservation – le ROI de votre visite noir sur blanc.', hinweis: 'Déjà inclus dans Signature Care & Evolution' },
          ...
          { name: 'Livraison express', price: '+30% sur le prix du forfait', nutzen: 'Votre visite terminée en 3 jours ouvrables au lieu de 5 à 10.' },
        ],
      },
    ],
  },
  ...
  ablauf: {
    ...
    steps: [
      ...
      { n: '4', t: 'Validation & mise en ligne', d: 'Vous vérifiez votre visite via le lien viewer et la validez. Après le paiement final, vous recevez le code d’intégration pour votre site – sur demande avec service de maintenance continu.' },
    ],
  },
  service: {
    kicker: 'Suivi & évolution',
    title: 'Forfaits de service annuels',
    subtitle: 'Optionnels et résiliables à tout moment – pour que votre visite reste actuelle, sûre et mesurable.',
    ...
    tiers: [
      ...
      { name: 'Signature Care', price: 'CHF 360.– / an', recommended: true, features: ['Tout le Basic Service', '3 adaptations par an', '1 mise à jour annuelle de la visite', 'Aperçu du comportement des visiteurs', 'Support prioritaire'] },
...
const en: PaketeContent = {
  hero: {
    ...
    subtitle: 'One-time price per tour, no subscription – the tour is yours. No contract, no platform rent.',
  },
  tiers: [
    {
      name: 'Basic',
  ...
  garantie: {
    ...
    markenText: 'Your tour carries your signature – colours, logo and navigation exactly to your corporate design, with no third-party branding (from the Signature Tour).',
  },
  rechner: {
    ...
    groups: [
      {
        ...
        items: [
          ...
          { name: 'Additional panoramas', price: 'from CHF 150.– per scene', nutzen: 'The tour grows with you – new areas can be added at any time.' },
      ...
      },
      {
        ...
        items: [
          { name: 'Multilingual version (DE / FR / EN)', price: 'from CHF 300.– per language', nutzen: 'Guests and buyers experience the tour in their language – more reach, more trust.' },
          { name: 'Google Street View & business integration', price: 'CHF 490.– one-time', nutzen: 'Your tour appears directly in Google Maps and your business profile – visible where customers search.' },
          { name: 'QR code print & display pack', price: 'CHF 240.–', nutzen: 'Window stickers, table stands and signs lead straight into the tour – your location becomes the gateway.' },
        ],
      },
      {
        title: '03 · Conversion & experience',
        items: [
          { name: 'Lead capture form inside the tour', price: 'CHF 390.– one-time', nutzen: 'Anonymous visitors become qualified enquiries – with name and e-mail address.' },
          ...
          { name: 'Signature Web – custom website', price: 'from CHF 2\'500.–', nutzen: 'Tour and website from one source – a seamless digital sales experience.' },
        ],
      },
      {
        title: '04 · Freshness, operations & reporting',
        items: [
          { name: 'Seasonal scene update', price: 'CHF 180.– per scene / season pack CHF 650.–', nutzen: 'Summer terrace, Christmas atmosphere, new planting – your tour stays current and alive.' },
          ...
          { name: 'Tour performance report', price: 'CHF 150.– per report', nutzen: 'Views, most popular rooms, clicks on booking points – your tour’s ROI in black and white.', hinweis: 'Already included in Signature Care & Evolution' },
  ...
  ablauf: {
    ...
    steps: [
      ...
      { n: '4', t: 'Approval & go-live', d: 'You review your tour conveniently via the viewer link and approve it. After the final payment you receive the embed link for your website – on request with ongoing maintenance service.' },
    ],
  },
  service: {
    kicker: 'Care & development',
    title: 'Annual service packages',
    subtitle: 'Optional and cancellable at any time – keeping your tour current, secure and measurable.',
  ...
  branchenPakete: [
    {
      ...
      cfg: 'immobilien',
      intro: 'For agents of premium and luxury properties. Every tour in Signature quality, fully in your corporate design.',
