...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  { title: 'Pakete & Preise', snippet: 'Basic CHF 990, Signature CHF 2\'497, Pro ab CHF 4\'497. Einmalpreis, kein Abo.', href: '/pakete', category: 'Seite', keywords: 'preis preise kosten paket pakete basic signature pro chf einmalpreis abo guenstig offerte' },
  ...
  // Themen / FAQ
  { title: 'Was kostet eine Tour?', snippet: 'Fixpakete ab CHF 990, transparent und ohne Abo.', href: '/pakete', category: 'Thema', keywords: 'preis kosten guenstig wieviel chf budget' },
  ...
  { title: 'Vergleich mit Matterport & Ogulo', snippet: 'Einmalpreis statt Abo, Done-for-You, Datenhoheit, sauberer Nadir.', href: '/', category: 'Thema', keywords: 'matterport ogulo vergleich konkurrenz abo alternative unterschied' },
  ...
  { title: 'Doppelte Garantie', snippet: 'Qualitäts- und Erfolgs-Garantie – 50% zurück bei keiner messbaren Verbesserung.', href: '/pakete', category: 'Thema', keywords: 'garantie geld zurueck risiko sicherheit qualitaet erfolg' },
