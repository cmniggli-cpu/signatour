...
export const BRANCHEN_DATA: Record<string, BranchenPageData> = {
  hotel: {
    ...
    metaDescription: 'Mehr Direktbuchungen, weniger OTA-Provisionen: Professionelle 360-Grad-Touren für Hotels ab CHF 3\'490. Schweizer Anbieter – die VR-Tour gehört Ihnen, kein Abo.',
    ...
    comparisonRows: [
      ...
      { label: 'Google-Sichtbarkeit', without: 'Standard-Eintrag', with: 'Bevorzugte Platzierung mit VR-Tour' },
      { label: 'Bildqualität', without: 'Handy-Schnappschüsse', with: 'Profi-Aufnahmen, sauberer Boden (Nadir)' },
    ],
    roiTitle: 'Schon 10 Direktbuchungen zahlen Ihre VR-Tour',
    roiSteps: [
    ...
    roiResult: 'Die VR-Tour amortisiert sich oft schon im ersten Quartal.',
    ...
    faqs: [
      ...
      { question: 'Kann die VR-Tour in unser Buchungssystem verlinken?', answer: 'Ja. Gäste können direkt aus dem Rundgang heraus für den Zimmertyp buchen, den sie gerade betrachten.' },
      { question: 'Funktioniert die VR-Tour auch auf Smartphones?', answer: 'Ja, vollständig responsiv. Keine App nötig. VR-Brillen werden ebenfalls unterstützt.' },
    ],
  },
  ...
  restaurant: {
    ...
    roiResult: 'Schon zwei Zusatz-Reservationen pro Woche zahlen die ganze VR-Tour.',
    extraSection: {
      ...
      items: [
        'VR-Tour direkt im Google Business Profile',
        'Höhere Klickrate auf Google Maps',
        'Mehr Anrufe, mehr Reservierungen',
        'Wettbewerbsvorteil vs. Restaurants ohne VR-Tour',
      ],
    },
    ...
    comparisonRows: [
      ...
      { label: 'Google Maps', without: 'Standard-Eintrag', with: 'VR-Tour im Profil – mehr Klicks & Anrufe' },
    ...
    faqs: [
      ...
      { question: 'Was passiert mit den alten Google-Fotos unserer Gäste?', answer: 'Die professionelle VR-Tour erscheint prominent. Gästefotos bleiben, aber Ihre virtuelle Tour dominiert den visuellen Ersteindruck.' },
    ],
  },
  ...
  'spa-wellness': {
    ...
    demoTour: { url: 'https://vtour.cloud/e16tqj/ee82pes6/#node69', title: 'AQUAVIRAT – Spa & Bäder', note: 'Echte Signature Tour: Pool, Saunalandschaft und Ruhebereiche – inklusive Buchung direkt in der VR-Tour.' },
    challenges: [
    ...
    stats: [
      ...
      { value: '67%', label: 'höhere Buchungswahrscheinlichkeit mit VR-Tour-Betrachtern' },
    ...
    sources: [
      ...
      { label: 'ScienceDirect: Virtuelle VR-Touren und Kundenzufriedenheit – Quasi-Experiment (Airbnb)', url: 'https://www.sciencedirect.com/science/article/abs/pii/S1447677025000105' },
    ],
    ...
    comparisonRows: [
      ...
      { label: 'Google-Sichtbarkeit', without: 'Standard-Eintrag', with: 'VR-Tour im Profil' },
      { label: 'Bildqualität', without: 'Schnappschüsse', with: 'Profi-Aufnahmen, sauberer Boden (Nadir)' },
    ],
    packageName: 'Spa & Wellness Premium-VR-Tour',
    packagePrice: 'ab CHF 3\'490.–',
    packageFeatures: [
  ...
  fitnessstudio: {
    ...
    stats: [
      { value: '130%', label: 'höhere Besuchswahrscheinlichkeit mit Google-Eintrag mit VR-Tour' },
      { value: '2×', label: 'mehr Google Maps Aufrufe vs. Einträge ohne VR-Tour' },
    ...
    sources: [
      ...
      { label: 'TeliportMe: Marktanalyse Virtual-VR-Tour-Software 2024', url: 'https://teliportme.com/blog/a-deep-dive-into-the-virtual-tour-software-market/' },
    ],
    ...
    roiTitle: '3 neue Mitglieder zahlen Ihre VR-Tour',
    roiSteps: [
    ...
    comparisonRows: [
      ...
      { label: 'Google Maps', without: 'Standard-Eintrag', with: 'VR-Tour im Profil – mehr Aufrufe' },
    ...
    faqs: [
      ...
      { question: 'Können wir die VR-Tour für Social Media nutzen?', answer: 'Ja, teilbarer Link für Instagram, Facebook, Newsletter, Bewertungsportale. Kein App-Download nötig.' },
    ],
  },
  ...
  immobilien: {
    ...
    sources: [
      { label: 'Matterport-Studie: Käufer und Verkäufer bevorzugen Inserate mit 3D-VR-Tour deutlich', url: 'https://matterport.com/news/new-study-shows-property-buyers-and-sellers-overwhelmingly-prefer-listings-3d-tours' },
      { label: 'Matterport: Objekte mit 3D-VR-Tour verkaufen sich bis zu 31% schneller', url: 'https://matterport.com/blog/3d-tours-properties-sell-31-faster-and-higher-price' },
    ...
    extraSection: {
      ...
      items: [
        'Homegate – Virtuelle VR-Tour direkt im Inserat',
        'ImmoScout24.ch – Maximale Sichtbarkeit durch VR-Tour-Integration',
    ...
    roiSteps: [
      { label: 'VR-Tour pro Objekt (10er-Karte)', value: 'CHF 1\'623.–' },
    ...
    packageFeatures: [
      ...
      'Jede VR-Tour in Signature-Qualität, voll im Corporate Design',
      'Flexibel einsetzbar, kein Ablaufdatum',
      'Google- & Portal-Einbindung je Objekt',
      'Inkl. 12 Monate Betreuungsservice pro VR-Tour',
    ],
    faqs: [
      { question: 'Wie schnell ist die VR-Tour nach dem Shooting verfügbar?', answer: 'In der Regel 5–10 Arbeitstage. Dringend: Express-Lieferung in 3 Arbeitstagen (+30%).' },
      { question: 'Was passiert, wenn das Objekt verkauft oder vermietet ist?', answer: 'VR-Tour wird deaktiviert/gelöscht. Nächste virtuelle Tour von der Karte für neues Objekt nutzen. Kein Ablaufdatum.' },
  ...
  'banken-versicherungen': {
    ...
    faqs: [
      ...
      { question: 'Lohnt sich das für eine kleine Kanzlei?', answer: 'Gerade dort: Mandanten vergleichen online, bevor sie anfragen. Wer als einzige Kanzlei am Ort seine Räume zeigt, hebt sich sichtbar ab – die VR-Tour arbeitet jahrelang ohne Folgekosten.' },
      { question: 'Geht das auch auf Französisch oder Englisch?', answer: 'Ja. Beratung & Aufträge auf Deutsch, Französisch und Englisch – und die VR-Tour selbst kann mehrsprachig umgesetzt werden (ab CHF 300 pro Zusatzsprache).' },
    ],
  },
  ...
  eventlocations: {
    ...
    challenges: [
      ...
      { title: 'Entscheidungen fallen im Vergleich', description: 'Wer mehrere Locations prüft, entscheidet nach dem Bauchgefühl aus dem ersten Online-Eindruck. Ohne VR-Tour fällt dieser Eindruck dünn aus.' },
    ],
    stats: [
      { value: '+40%', label: 'mehr Leads mit virtueller Showroom-VR-Tour' },
      { value: '+30%', label: 'höhere Online-Interaktion mit 360°-Showroom' },
      { value: '2×', label: 'mehr Interesse bei Google-Einträgen mit VR-Tour' },
      { value: '24/7', label: 'Besichtigung möglich – auch sonntags um 22 Uhr' },
    ],
    sources: [
      { label: 'Travvir: Virtuelle VR-Touren bringen rund 40% mehr Leads als reine Fotos (Automotive)', url: 'https://travvir.com/blog/en/virtual-tour-car-dealerships' },
      { label: 'Spyne: +30% Kundeninteraktion mit 3D-/360°-Showroom-VR-Touren', url: 'https://www.spyne.ai/blogs/3d-virtual-tours-for-car-dealerships' },
    ...
    extraSection: {
      title: 'Varianten und Unterlagen direkt in der VR-Tour',
      description: 'Eine Location verkauft sich über Möglichkeiten. Die VR-Tour zeigt sie alle – an einem Ort.',
      items: [
        'Bestuhlungsvarianten (Bankett, Konzert, Seminar) als Panorama-Varianten',
        'Technische Datenblätter, Pläne und Catering-Unterlagen als PDF-Download in der VR-Tour',
    ...
    roiTitle: 'Ein gebuchtes Event zahlt Ihre VR-Tour',
    roiSteps: [
    ...
    comparisonRows: [
      ...
      { label: 'Unterlagen', without: 'Separate PDFs verschicken', with: 'Technik & Catering direkt in der VR-Tour' },
    ...
    faqs: [
      { question: 'Können wir verschiedene Bestuhlungen zeigen?', answer: 'Ja. Wir fotografieren den Saal in mehreren Varianten (z.B. Bankett und Konzert) – Besucher schalten in der VR-Tour zwischen den Ansichten um.' },
      { question: 'Was passiert nach einem Umbau oder neuer Deko?', answer: 'Einzelne Panoramen lassen sich ab CHF 180.– pro Szene aktualisieren, ohne die VR-Tour neu zu erstellen. Ideal auch für saisonale Stimmungen.' },
      { question: 'Können Eventplaner die VR-Tour in ihre Unterlagen einbauen?', answer: 'Ja. Die virtuelle Tour ist per Link teilbar und per iFrame einbettbar – perfekt für Offerten, Pitch-Decks und Partner-Websites.' },
      { question: 'Wie lange dauert das Shooting?', answer: 'Je nach Grösse 2–4 Stunden, idealerweise wenn die Location eingerichtet und leer ist. Die fertige VR-Tour liefern wir in 5–10 Arbeitstagen.' },
    ],
  },
}
