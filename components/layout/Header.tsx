    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <Link href={loc('/')} className="flex items-center gap-2.5">
                ...
                {item.children ? (
                        ...
                        {item.children.map((child) => (
                          <Link
                            ...
                            className={cn(
                              ...
                              pathname === loc(child.href) && 'text-primary-900 bg-cream font-medium'
                            )}
                          >
                            {child.label}
                          </Link>
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      'text-primary-600 hover:text-primary-900 hover:bg-primary-100/50',
                      pathname === loc(item.href) && 'text-primary-900 bg-primary-100/50'
                    )}
                  >
                    {item.label}
                  </Link>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <LanguageSwitcher />
            <SiteSearch />
            <Button href={loc('/kontakt')} variant="primary" size="sm">{t.nav.beratungCta}</Button>
          </div>
