...
import { locales, localeLabels, defaultLocale, isLocalizedPath, type Locale } from '@/lib/i18n/config'
...
function hrefFor(locale: Locale, basePath: string): string {
  ...
  // Seiten ohne Übersetzung: auf die Startseite der Zielsprache wechseln.
  if (basePath === '/' || basePath === '' || !isLocalizedPath(basePath)) return `/${locale}`
